const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      limit: '限制',
      crawlSubPage: '抓取子頁面',
      firecrawlDocLink: 'https://docs.cubix.ai/en/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
      preview: '預覽',
      configure: '配置',
      excludePaths: '排除路徑',
      options: '選項',
      ...
      watercrawlDocLink: 'https://docs.cubix.ai/zh-TW/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
  ...
  otherDataSource: {
    learnMore: '瞭解更多資訊',
    description: '目前，Cubix 的知識庫只有有限的數據源。向 Cubix 知識庫貢獻數據源是説明所有使用者增強平台靈活性和強大功能的絕佳方式。我們的貢獻指南使入門變得容易。請點擊下面的連結瞭解更多資訊。',
    title: '連接到其他數據源？',
  },
  watercrawl: {
