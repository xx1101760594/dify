const translation = {
  ...
  duplicateTitle: '复制应用',
  export: '导出工程文件',
  exportFailed: '导出工程文件失败',
  importDSL: '导入工程文件',
  createFromConfigFile: '通过工程文件创建',
  importFromDSL: '导入工程文件',
  importFromDSLFile: '文件',
  importFromDSLUrl: 'URL',
  importFromDSLUrlPlaceholder: '输入工程文件的 URL',
  ...
  newApp: {
    ...
    appCreated: '应用已创建',
    caution: '注意',
    appCreateDSLWarning: '注意：工程版本差异可能影响部分功能表现',
    appCreateDSLErrorTitle: '版本不兼容',
    appCreateDSLErrorPart1: '检测到工程版本差异较大，强制导入应用可能无法正常运行。',
    appCreateDSLErrorPart2: '是否继续？',
    appCreateDSLErrorPart3: '当前应用工程版本：',
    appCreateDSLErrorPart4: '系统支持工程版本：',
