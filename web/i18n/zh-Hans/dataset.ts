const translation = {
  ...
  externalAPIPanelDescription: '外部知识库 API 用于连接到的知识库并从中检索知识。',
  ...
  retrieval: {
    ...
    ppr_search: {
      title: '知识图谱检索',
      description: '通过构建实体关系图谱，基于实体及其语义关联进行问答和片段检索',
    },
    all_hybrid: {
      title: '向量检索+全文检索+知识图谱检索'
    },
    fulltext_ppr_hybrid: {
      title: '全文检索+知识图谱检索'
    },
  ...
  indexingMethod: {
    ...
    hybrid_search: '混合检索',
    invertedIndex: '倒排索引',
    hybrid_search_with_graph: '混合检索',
    ppr_search: '知识图谱检索',
    all_hybrid: '向量检索+全文检索+知识图谱检索',
    semantic_fulltext_hybrid: '向量检索+全文检索',
    semantic_ppr_hybrid: '向量检索+知识图谱检索',
    fulltext_ppr_hybrid: '全文检索+知识图谱检索',
  },
  ...
  metadata: {
    ...
    createMetadata: {
      ...
      type: '类型',
      name: '名称',
      namePlaceholder: '添加标签名称',
    },
    checkName: {
      empty: '标签名称不能为空',
      invalid: '标签名称只能包含小写字母、数字和下划线，并且必须以小写字母开头',
    },
    batchEditMetadata: {
      editMetadata: '编辑标签',
      editDocumentsNum: '编辑 {{num}} 个文档',
      applyToAllSelectDocument: '应用于所有选定文档',
      applyToAllSelectDocumentTip: '自动为所有选定文档创建上述编辑和新标签，否则仅对具有标签的文档应用编辑。',
      multipleValue: '多个值',
    },
    selectMetadata: {
      search: '搜索标签',
    ...
    datasetMetadata: {
      description: '标签是关于文档的数据，用于描述文档的属性。标签可以帮助您更好地组织和管理文档。',
      addMetaData: '添加标签',
      values: '{{num}} 个值',
      disabled: '已禁用',
      rename: '重命名',
      ...
      builtIn: '内置',
      builtInDescription: '内置标签是系统预定义的标签，您可以在此处查看和管理内置标签。',
      deleteTitle: '确定删除',
      deleteContent: '你确定要删除标签 "{{name}}" 吗?',
    },
    documentMetadata: {
      metadataToolTip: '标签是关于文档的数据，用于描述文档的属性。标签可以帮助您更好地组织和管理文档。',
      startLabeling: '开始标注',
