const translation = {
  ...
  nodes: {
    ...
    knowledgeRetrieval: {
      ...
      metadata: {
        title: '标签过滤',
        tip: '标签过滤是使用标签属性（例如标签、类别或访问权限）来细化和控制系统内相关信息的检索过程。',
        options: {
          disabled: {
            title: '禁用',
            subTitle: '禁用标签过滤',
          ...
          automatic: {
            title: '自动',
            subTitle: '根据用户查询自动生成标签过滤条件',
            desc: '根据 Query Variable 自动生成标签过滤条件',
          },
          manual: {
            title: '手动',
            subTitle: '手动添加标签过滤条件',
    ...
    database: {
      ...
      empty: {
        title: '暂无数据库',
        description: '您还没有创建任何数据库连接。创建数据库连接后，可以在工作流中使用数据库查询功能。',
        createButton: '创建数据库连接',
      },
    },
  },
  tracing: {
