const translation = {
  pageTitle: '嗨，近来可好',
  welcome: '👋 欢迎来到 CloudWalk Cubix, 登录以继续',
  email: '邮箱',
  ...
  licenseExpiredTip: '您所在空间的Enterprise 许可证已过期，请联系管理员以继续使用 CloudWalk Cubix。',
  licenseLost: '许可证丢失',
  licenseLostTip: '无法连接许可证服务器，请联系管理员以继续使用 CloudWalk Cubix。',
  licenseInactive: '许可证未激活',
  licenseInactiveTip: '您所在空间的Enterprise 许可证尚未激活，请联系管理员以继续使用 CloudWalk Cubix。',
}
