const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      // firecrawlDocLink: 'https://docs.ceri.ai/zh-hans/guides/knowledge-base/create-knowledge-and-upload-documents/import-content-data/sync-from-website',
      firecrawlDocLink: '',
  ...
  stepTwo: {
    ...
    previewChunkTip: '点击上侧的“预览块”按钮来加载预览',
